        ...
        <div className="flex gap-3 overflow-x-auto px-4 py-3 lg:px-0 lg:flex-wrap scrollbar-hide">
          {liveIndices.map(index => (
            <button
              ...
              className="w-[230px] min-w-[200px] max-w-[190px] flex-shrink-0 rounded-lg border border-border bg-card px-4 py-2.5 text-left transition-colors hover:border-primary/30"
            >
